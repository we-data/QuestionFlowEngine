...
public class QuestionAnswerFileDataAttribute : DataAttribute
{
    ...
    public QuestionAnswerFileDataAttribute(string filePath)
        : this(filePath, null) { }
    ...
    public QuestionAnswerFileDataAttribute(string filePath, string propertyName)
    {
        _filePath = filePath;
    ...
    public override IEnumerable<object[]> GetData(MethodInfo testMethod)
    {
        ...
        return new List<object[]>() { data.ToObject<QuestionAnswer[]>() };
    }
}
